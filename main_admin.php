...
if(!isset($_SESSION['admin_username'])) {
  ...
  <div id="welcome">
  Welcome: user, <span><?php echo $_SESSION['admin_username'] ?> </span> to assignment schedule. The time is <?php echo date('h:i:sa'); ?> 
  ...
  <select name="courseToRemove">
  <option value="">Select a course:</option>
    <?php include("additional/coursesSelector.php")?>
  </select>
  <input type="submit" name="rmCourse">
  </form>
