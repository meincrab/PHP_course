        ...
        <form method="post" action="<?php $_SERVER["PHP_SELF"] ?>" id="loginform"  name="loginform">
            <p>
                ...
                <label for="user_login">Login<br>
                    <input type="text" class="input" id="username" name="username" size="20" value="">
                </label>
            </p>
            <p>
                <label for="user_password">Password<br>
                    <input type="password" class="input" id="userpass" name="password" value="">
                </label>
            </p>
            <p>
                <input type="submit" value="Get Inside" class = "" name="submit">
            </p>         
        </form>
        <p>
